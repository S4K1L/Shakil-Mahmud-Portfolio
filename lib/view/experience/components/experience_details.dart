              ...
              children: [
                ...
                Text.rich(
                  ...
                  TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: certificateList[index].position,style: const TextStyle(color: Colors.grey,overflow: TextOverflow.ellipsis),)
                      ]
                  ),),
                const SizedBox(height: defaultPadding,),
                InkWell(
                  onTap: () {
                    launchUrl(Uri.parse(certificateList[index].link));
                  },
                  child: Container(
                    height: 40,
                    width: 150,
                    ...
                    child: const Row(
                      ...
                      children: [
                        Text('Visit Now',style: TextStyle(color: Colors.white,fontSize: 10),),
                        SizedBox(width: 5,),
                        Icon(
